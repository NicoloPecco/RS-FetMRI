...
global_threshold=1.5;         % threshold for outlier detection based on global signal
motion_threshold=2.0;         % threshold for outlier detection based on motion estimates
use_diff_motion=0;            % 1: uses scan-to-scan motion to determine outliers; 0: uses absolute motion
use_diff_global=0;            % 1: uses scan-to-scan global signal change to determine outliers; 0: uses absolute global signal values
